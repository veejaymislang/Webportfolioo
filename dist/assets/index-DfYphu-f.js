(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(){return`
  ...
  `}var n=`/assets/K-c-rD_SRC.jpg`;function r(){return`
    <style>
      #about {
        padding: 100px 0;
      }
  ...
  `}var p=`/assets/cert1-C9zPbLiE.jpg`;function m(){let e=[{title:`PHP WITH MYSQL`,issuer:`Simplilearn SkillUP`,year:`Aug 2024`,image:p,desc:`Successfully completed the online course on Introduction to SQL, demonstrating initiative and commitment to advancing database skills.`}];return setTimeout(()=>{typeof window<`u`&&!window.openLightbox&&(window.openLightbox=(e,t)=>{let n=document.getElementById(`cert-lightbox`);n&&(n.querySelector(`.lb-img`).src=e,n.querySelector(`.lb-title`).textContent=t,n.style.display=`flex`,setTimeout(()=>n.classList.add(`lb-visible`),10))},window.closeLightbox=()=>{let e=document.getElementById(`cert-lightbox`);e&&(e.classList.remove(`lb-visible`),setTimeout(()=>{e.style.display=`none`},300))})},100),`
    <style>
      .certs-grid {
        display: grid;
        grid-template-columns: repeat(3, 1fr);
